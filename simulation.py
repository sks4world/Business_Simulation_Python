...
def function1b():
	...
	monthly_forecast = forecast/12
	forecast_80pc = forecast*0.8
	forecast_120pc = forecast*1.2
	#print(capacity_4_rounds)

	df_pa_sa_t['Forecast'] = 0
	df_pa_sa_t['Capacity_4_Rounds'] = 0
	df_pa_sa_t['Monthly_Forecast'] = 0
	...
	df_pa_sa_t.loc[df_pa_sa_t['Name'] == 'Able', ['Monthly_Forecast']] = monthly_forecast
	...
	#Add the forecast value to new dataframe to put in a table
	#cols = ['Primary_Segment', 'Name', 'Forecast_Actual']
	#df_predict = pd.DataFrame(cols)
	#df_predict.append(['Trad', 'Able', forecast])
	c = ['Primary_Segment', 'Name', 'Forecast_Actual', 'Forecast_80pc', 'Forecast_120pc','Demand', 'Total_Score', 'Score', 'Score_Pc', 'Growth']
	d = {'Primary_Segment': 'Trad', 'Name': 'Able', 'Forecast_Actual': forecast*100, 'Forecast_80pc': forecast_80pc*100, 'Forecast_120pc':forecast_120pc*100,'Demand':demand*100, 'Total_Score':tot_score*10, 'Score':prod_score*10, 'Score_Pc': score_pc, 'Growth': growth}
	df_predict = pd.DataFrame(data=d, columns=c, index=[0])
	#print(df_predict)
	...
	#Add the forecast value to new dataframe to put in a table
	d = {'Primary_Segment': 'Low', 'Name': 'Acre', 'Forecast_Actual': forecast*100, 'Forecast_80pc': forecast_80pc*100, 'Forecast_120pc':forecast_120pc*100,'Demand':demand*100, 'Total_Score':tot_score*10, 'Score':prod_score*10, 'Score_Pc': score_pc, 'Growth': growth}
	#df_predict_l = pd.DataFrame(data=d, index=[0])
	#df_predict.append(df_predict_l)
	...
	#Add the forecast value to new dataframe to put in a table
	d = {'Primary_Segment': 'High', 'Name': 'Adam', 'Forecast_Actual': forecast*100, 'Forecast_80pc': forecast_80pc*100, 'Forecast_120pc':forecast_120pc*100,'Demand':demand*100, 'Total_Score':tot_score*10, 'Score':prod_score*10, 'Score_Pc': score_pc, 'Growth': growth}
	#df_predict_l = pd.DataFrame(data=d, index=[0])
	#df_predict.append(df_predict_l)
	df_predict = df_predict.append(d, ignore_index=True)
	...
	#Add the forecast value to new dataframe to put in a table
	d = {'Primary_Segment': 'Pfmn', 'Name': 'Aft', 'Forecast_Actual': forecast*100, 'Forecast_80pc': forecast_80pc*100, 'Forecast_120pc':forecast_120pc*100,'Demand':demand*100, 'Total_Score':tot_score*10, 'Score':prod_score*10, 'Score_Pc': score_pc, 'Growth': growth}
	#df_predict_l = pd.DataFrame(data=d, index=[0])
	#df_predict.append(df_predict_l)
	df_predict = df_predict.append(d, ignore_index=True)
	...
	#Add the forecast value to new dataframe to put in a table
	d = {'Primary_Segment': 'Size', 'Name': 'Agape', 'Forecast_Actual': forecast*100, 'Forecast_80pc': forecast_80pc*100, 'Forecast_120pc':forecast_120pc*100,'Demand':demand*100, 'Total_Score':tot_score*10, 'Score':prod_score*10, 'Score_Pc': score_pc, 'Growth': growth}
	#df_predict_l = pd.DataFrame(data=d, index=[0])
	#df_predict.append(df_predict_l)
	df_predict = df_predict.append(d, ignore_index=True)
	...
	with PdfPages(filename) as pdf:
		#Traditional
		ax = df_pa_sa_t.plot.bar(x='Name', y=['Units_Sold', 'Price', 'Pfmn_Coord_x', 'Size_Coord_x', 'Age_Dec_31_x', 'Cust_Awareness', 'Cust_Accessibility', 'Dec_Cust_Survey', 'Forecast', 'Capacity_4_Rounds', 'Plant_Utiliz'], rot=0, fontsize=5, grid=True, width=0.7)
		...
		#second data frame
		pdf.attach_note("Multiply Units Sold, Forecast and Capacity by 100, Customer Awareness, Accessibility and Dec Cust Survey Score by 10. Mean")
		
		#Text
		txt = 'pfmn_exp= '+str(pfmn_exp) +' '+ 'size_exp= '+str(size_exp)
		ax.text(0,30, txt, size=6)

		pdf.savefig()
		plt.close()

		#Lowend
		ax = df_pa_sa_l.plot.bar(x='Name', y=['Units_Sold', 'Price', 'Pfmn_Coord_x', 'Size_Coord_x', 'Age_Dec_31_x', 'Cust_Awareness', 'Cust_Accessibility', 'Dec_Cust_Survey', 'Forecast', 'Capacity_4_Rounds', 'Plant_Utiliz'], rot=0, fontsize=5, grid=True, width=0.7)
		...
		#Highend
		ax = df_pa_sa_h.plot.bar(x='Name', y=['Units_Sold', 'Price', 'Pfmn_Coord_x', 'Size_Coord_x', 'Age_Dec_31_x', 'Cust_Awareness', 'Cust_Accessibility', 'Dec_Cust_Survey', 'Forecast', 'Capacity_4_Rounds', 'Plant_Utiliz'], rot=0, fontsize=5, grid=True, width=0.7)
		...
		#Performance
		ax = df_pa_sa_p.plot.bar(x='Name', y=['Units_Sold', 'Price', 'Pfmn_Coord_x', 'Size_Coord_x', 'Age_Dec_31_x', 'Cust_Awareness', 'Cust_Accessibility', 'Dec_Cust_Survey', 'Forecast', 'Capacity_4_Rounds', 'Plant_Utiliz'], rot=0, fontsize=5, grid=True, width=0.7)
		...
		#Size
		ax = df_pa_sa_s.plot.bar(x='Name', y=['Units_Sold', 'Price', 'Pfmn_Coord_x', 'Size_Coord_x', 'Age_Dec_31_x', 'Cust_Awareness', 'Cust_Accessibility', 'Dec_Cust_Survey', 'Forecast', 'Capacity_4_Rounds', 'Plant_Utiliz'], rot=0, fontsize=5, grid=True, width=0.7)
		...
		#Pfmn line chart
		ax1 = df_icr.plot(x='Round', y=['Pfmn_t', 'Pfmn_l', 'Pfmn_h', 'Pfmn_p', 'Pfmn_s'], linestyle='-', linewidth=2, fontsize=5, grid=True)
		ax1.set_title(('Pfmn values by round'), fontsize = 10)
		ax1.set_yticks(np.arange(0,20, step=1))
		ax1.grid(color='g', linestyle='-', linewidth=0.5)
		ax1.legend(loc=1, prop={'size':8})
		ax1.axhline(9, linestyle='-', linewidth=1, color='black')
		ax1.axhline(10.5, linestyle='-', linewidth=1, color='black')

		#Table
		#ax1.table(cellText=df_icr.values, colLabels=df_icr.columns, loc='center')
		#fig.tight_layout()
		#print(df_icr.Pfmn_t)
		...
		#Size line chart
		ax1 = df_icr.plot(x='Round', y=['Size_t', 'Size_l', 'Size_h', 'Size_p', 'Size_s'], linestyle='-', linewidth=2, fontsize=5, grid=True)
		ax1.set_title(('Size values by round'), fontsize = 10)
		ax1.set_yticks(np.arange(0,20, step=1))
		ax1.grid(color='g', linestyle='-', linewidth=0.5)
		ax1.legend(loc=1, prop={'size':8})
		ax1.axhline(9.5, linestyle='-', linewidth=1, color='black')
		ax1.axhline(11, linestyle='-', linewidth=1, color='black')
		...
		ax = plt.subplot(111)
		ax.axis('off')
		t = ax.table(cellText=df_predict.values, colLabels=df_predict.columns, bbox=[0,0,1,1])
		t.set_fontsize(7)

		pdf.savefig()
		plt.close()

		#Month wise customer survey score and forecast
		# col_names = ['Name', 'Age_Dec_31', 'Dec_Cust_Survey']
		# df_predict = pd.DataFrame(columns=col_names) #Create a new empty Data Frame
		# print(df_predict)
		df_pa_sa_bc = df_pa_sa.merge(df_bc[['Primary_Segment', 'Age_Exp', 'Age_Imp_Pc']], on=['Primary_Segment'])
		df_pa_sa_bc['Age_Jan_31'] = df_sa['Age_Dec_31'].apply(lambda x: x+0.1)
		df_pa_sa_bc['Age_Points'] = np.where(df_pa_sa_bc['Age_Jan_31']==df_pa_sa_bc['Age_Exp'], df_pa_sa_bc['Age_Imp_Pc'],0)
		#df_pa_sa_bc['Age_Points'] = df_pa_sa_bc['Age_Points'].apply(lambda x: x['Age_Points'] if x['Age_Points']>0 else x['Age_Points'])
		#print(df_pa_sa['Age_Jan_31'])
		#print(df_pa_sa['Age_Points'])
		#print(df_pa_sa_bc['Age_Exp'])
		#print(df_pa_sa_bc['Age_Imp_Pc'])
		#print(df_pa_sa_bc['Age_Points'])
...
def function1c():
	...
	growth = 1 + (df_bc_t.Growth_Rate_Pc.min()/100)
	forecast = (demand * score_pc * growth)
	capacity_4_rounds = forecast * (growth ** 2)
	monthly_forecast = forecast/12
	forecast_80pc = forecast*0.8
	forecast_120pc = forecast*1.2
	#print(capacity_4_rounds)
	c2r = forecast * (growth ** 2) * 100
	cap_nxt_rnd = df_pa_sa_t['Capacity_Next_Round'].sum()
	exp_demand = demand*100*growth
	...
	#df_predict = pd.DataFrame(cols)
	#df_predict.append(['Trad', 'Able', forecast])
	c = ['Primary_Segment', 'Name', 'Forecast_Actual', 'Forecast_80pc', 'Forecast_120pc','Demand', 'Total_Score', 'Score', 'Score_Pc', 'Growth', 'Capacity_2_Rounds', '']
	d = {'Primary_Segment': 'Trad', 'Name': 'Able', 'Forecast_Actual': forecast*100, 'Forecast_80pc': forecast_80pc*100, 'Forecast_120pc':forecast_120pc*100,'Demand':demand*100, 'Total_Score':tot_score*10, 'Score':prod_score*10, 'Score_Pc': score_pc, 'Growth': growth, 'Capacity_2_Rounds': c2r}
	df_predict = pd.DataFrame(data=d, columns=c, index=[0])
	#print(df_predict)

	#Capacity Next Round by Segment
	c1 = ['Primary_Segment', 'Capacity_Next_Round', 'Expected_Demand']
	d1 = {'Primary_Segment': 'Trad', 'Capacity_Next_Round': cap_nxt_rnd, 'Expected_Demand':exp_demand}
	df_seg_cap = pd.DataFrame(data=d1, columns=c1, index=[0])

	#Size transformed to Traditional
	#Forecast
	demand = df_icr_round['Total_demand_t'].min()/100
	tot_score = df_pa_sa_t.Dec_Cust_Survey.sum()
	prod_score = df_pa_sa_t[df_pa_sa_t.Name == 'Agape'].Dec_Cust_Survey.sum().astype(float)
	score_pc = prod_score / tot_score
	growth = 1 + (df_bc_t.Growth_Rate_Pc.min()/100)
	forecast = (demand * score_pc * growth)
	capacity_4_rounds = forecast * (growth ** 2)
	...
	df_pa_sa_t['Forecast'] = 0
	df_pa_sa_t['Capacity_4_Rounds'] = 0
	df_pa_sa_t.loc[df_pa_sa_t['Name'] == 'Agape', ['Forecast']] = forecast
	df_pa_sa_t.loc[df_pa_sa_t['Name'] == 'Agape', ['Capacity_4_Rounds']] = capacity_4_rounds

	#Add the forecast value to new dataframe to put in a table
	d = {'Primary_Segment': 'Trad', 'Name': 'Agape', 'Forecast_Actual': forecast*100, 'Forecast_80pc': forecast_80pc*100, 'Forecast_120pc':forecast_120pc*100,'Demand':demand*100, 'Total_Score':tot_score*10, 'Score':prod_score*10, 'Score_Pc': score_pc, 'Growth': growth, 'Capacity_2_Rounds': c2r}
	#df_predict_l = pd.DataFrame(data=d, index=[0])
	#df_predict.append(df_predict_l)
	df_predict = df_predict.append(d, ignore_index=True)
	#Capacity Next Round by Segment
	d1 = {'Primary_Segment': 'Trad', 'Capacity_Next_Round': cap_nxt_rnd, 'Expected_Demand':exp_demand}
	df_seg_cap = df_seg_cap.append(d1, ignore_index=True)
	...
	#print(capacity_4_rounds)
	c2r = forecast * (growth ** 2) * 100
	cap_nxt_rnd = df_pa_sa_l['Capacity_Next_Round'].sum()
	exp_demand = demand*100*growth
	df_pa_sa_l['Forecast'] = 0
	df_pa_sa_l['Capacity_4_Rounds'] = 0
	df_pa_sa_l.loc[df_pa_sa_l['Name'] == 'Acre', ['Forecast']] = forecast
	...
	#Add the forecast value to new dataframe to put in a table
	d = {'Primary_Segment': 'Low', 'Name': 'Acre', 'Forecast_Actual': forecast*100, 'Forecast_80pc': forecast_80pc*100, 'Forecast_120pc':forecast_120pc*100,'Demand':demand*100, 'Total_Score':tot_score*10, 'Score':prod_score*10, 'Score_Pc': score_pc, 'Growth': growth, 'Capacity_2_Rounds': c2r}
	#df_predict_l = pd.DataFrame(data=d, index=[0])
	#df_predict.append(df_predict_l)
	df_predict = df_predict.append(d, ignore_index=True)
	#print(df_predict)
	#Capacity Next Round by Segment
	d1 = {'Primary_Segment': 'Low', 'Capacity_Next_Round': cap_nxt_rnd, 'Expected_Demand':exp_demand}
	df_seg_cap = df_seg_cap.append(d1, ignore_index=True)
	...
	#print(capacity_4_rounds)
	c2r = forecast * (growth ** 2) * 100
	cap_nxt_rnd = df_pa_sa_h['Capacity_Next_Round'].sum()
	exp_demand = demand*100*growth
	df_pa_sa_h['Forecast'] = 0
	df_pa_sa_h['Capacity_4_Rounds'] = 0
	df_pa_sa_h.loc[df_pa_sa_h['Name'] == 'Adam', ['Forecast']] = forecast
	...
	#Add the forecast value to new dataframe to put in a table
	d = {'Primary_Segment': 'High', 'Name': 'Adam', 'Forecast_Actual': forecast*100, 'Forecast_80pc': forecast_80pc*100, 'Forecast_120pc':forecast_120pc*100,'Demand':demand*100, 'Total_Score':tot_score*10, 'Score':prod_score*10, 'Score_Pc': score_pc, 'Growth': growth, 'Capacity_2_Rounds': c2r}
	#df_predict_l = pd.DataFrame(data=d, index=[0])
	#df_predict.append(df_predict_l)
	df_predict = df_predict.append(d, ignore_index=True)
	#Capacity Next Round by Segment
	d1 = {'Primary_Segment': 'High', 'Capacity_Next_Round': cap_nxt_rnd, 'Expected_Demand':exp_demand}
	df_seg_cap = df_seg_cap.append(d1, ignore_index=True)

	#Highend - Ale
	prod_score = df_pa_sa_h[df_pa_sa_h.Name == 'Ale'].Dec_Cust_Survey.sum().astype(float)
	score_pc = prod_score / tot_score
	growth = 1 + (df_bc_h.Growth_Rate_Pc.min()/100)
	forecast = (demand * score_pc * growth)
	capacity_4_rounds = forecast * (growth ** 2)
	...
	df_pa_sa_h['Forecast'] = 0
	df_pa_sa_h['Capacity_4_Rounds'] = 0
	df_pa_sa_h.loc[df_pa_sa_h['Name'] == 'Ale', ['Forecast']] = forecast
	df_pa_sa_h.loc[df_pa_sa_h['Name'] == 'Ale', ['Capacity_4_Rounds']] = capacity_4_rounds

	#Add the forecast value to new dataframe to put in a table
	d = {'Primary_Segment': 'High', 'Name': 'Ale', 'Forecast_Actual': forecast*100, 'Forecast_80pc': forecast_80pc*100, 'Forecast_120pc':forecast_120pc*100,'Demand':demand*100, 'Total_Score':tot_score*10, 'Score':prod_score*10, 'Score_Pc': score_pc, 'Growth': growth, 'Capacity_2_Rounds': c2r}
	#df_predict_l = pd.DataFrame(data=d, index=[0])
	#df_predict.append(df_predict_l)
	df_predict = df_predict.append(d, ignore_index=True)
	#Capacity Next Round by Segment
	...
	#print(capacity_4_rounds)
	c2r = forecast * (growth ** 2) * 100
	cap_nxt_rnd = df_pa_sa_p['Capacity_Next_Round'].sum()
	exp_demand = demand*100*growth
	df_pa_sa_p['Forecast'] = 0
	df_pa_sa_p['Capacity_4_Rounds'] = 0
	df_pa_sa_p.loc[df_pa_sa_p['Name'] == 'Aft', ['Forecast']] = forecast
	...
	#Add the forecast value to new dataframe to put in a table
	d = {'Primary_Segment': 'Pfmn', 'Name': 'Aft', 'Forecast_Actual': forecast*100, 'Forecast_80pc': forecast_80pc*100, 'Forecast_120pc':forecast_120pc*100,'Demand':demand*100, 'Total_Score':tot_score*10, 'Score':prod_score*10, 'Score_Pc': score_pc, 'Growth': growth, 'Capacity_2_Rounds': c2r}
	#df_predict_l = pd.DataFrame(data=d, index=[0])
	#df_predict.append(df_predict_l)
	df_predict = df_predict.append(d, ignore_index=True)
	#Capacity Next Round by Segment
	d1 = {'Primary_Segment': 'Pfmn', 'Capacity_Next_Round': cap_nxt_rnd, 'Expected_Demand':exp_demand}
	df_seg_cap = df_seg_cap.append(d1, ignore_index=True)

	#Performance - Alex
	prod_score = df_pa_sa_p[df_pa_sa_p.Name == 'Alex'].Dec_Cust_Survey.sum().astype(float)
	score_pc = prod_score / tot_score
	growth = 1 + (df_bc_p.Growth_Rate_Pc.min()/100)
	forecast = (demand * score_pc * growth)
	capacity_4_rounds = forecast * (growth ** 2)
	...
	df_pa_sa_h['Forecast'] = 0
	df_pa_sa_h['Capacity_4_Rounds'] = 0
	df_pa_sa_h.loc[df_pa_sa_h['Name'] == 'Alex', ['Forecast']] = forecast
	df_pa_sa_h.loc[df_pa_sa_h['Name'] == 'Alex', ['Capacity_4_Rounds']] = capacity_4_rounds

	#Add the forecast value to new dataframe to put in a table
	d = {'Primary_Segment': 'Pfmn', 'Name': 'Alex', 'Forecast_Actual': forecast*100, 'Forecast_80pc': forecast_80pc*100, 'Forecast_120pc':forecast_120pc*100,'Demand':demand*100, 'Total_Score':tot_score*10, 'Score':prod_score*10, 'Score_Pc': score_pc, 'Growth': growth, 'Capacity_2_Rounds': c2r}
	#df_predict_l = pd.DataFrame(data=d, index=[0])
	#df_predict.append(df_predict_l)
	df_predict = df_predict.append(d, ignore_index=True)
	...
	#print(capacity_4_rounds)
	c2r = forecast * (growth ** 2) * 100
	cap_nxt_rnd = df_pa_sa_s['Capacity_Next_Round'].sum()
	exp_demand = demand*100*growth
	df_pa_sa_s['Forecast'] = 0
	df_pa_sa_s['Capacity_4_Rounds'] = 0
	df_pa_sa_s.loc[df_pa_sa_s['Name'] == 'Agape', ['Forecast']] = forecast
	...
	#Add the forecast value to new dataframe to put in a table
	d = {'Primary_Segment': 'Size', 'Name': 'Agape', 'Forecast_Actual': forecast*100, 'Forecast_80pc': forecast_80pc*100, 'Forecast_120pc':forecast_120pc*100,'Demand':demand*100, 'Total_Score':tot_score*10, 'Score':prod_score*10, 'Score_Pc': score_pc, 'Growth': growth, 'Capacity_2_Rounds': c2r}
	#df_predict_l = pd.DataFrame(data=d, index=[0])
	#df_predict.append(df_predict_l)
	df_predict = df_predict.append(d, ignore_index=True)
	#Capacity Next Round by Segment
	d1 = {'Primary_Segment': 'Size', 'Capacity_Next_Round': cap_nxt_rnd, 'Expected_Demand':exp_demand}
	df_seg_cap = df_seg_cap.append(d1, ignore_index=True)
	...
	with PdfPages(filename) as pdf:
		...
		ax2 = df_seg_cap.plot.bar(x='Primary_Segment', y=['Capacity_Next_Round'], rot=0, fontsize=5, grid=True, width=0.7)
		ax2.set_title(('Capacity Next Round By Segment'), fontsize = 10)
		ax2.set_yticks(np.arange(0,20000, step=1000))
		pdf.savefig()
		plt.close()
...
#Change width of bars in barchart: https://stackoverflow.com/questions/886716/controlling-bars-width-in-matplotlib-with-per-month-data
#Merge dataframe: https://pandas.pydata.org/pandas-docs/stable/user_guide/merging.html
#Conditionally update a column based on another column value in a data frame https://chrisalbon.com/python/data_wrangling/pandas_create_column_using_conditional/
#Lookup another dataframe and merge https://stackoverflow.com/questions/25611220/pandas-lookup-mapping-one-column-in-a-dataframe-to-another-in-a-different-dataf
#Draw a table in PDF using dataframe:https://stackoverflow.com/questions/53828284/how-to-save-pandas-dataframe-into-existing-pdf-from-pdfpages
#Append rows to dataframe: https://stackoverflow.com/questions/10715965/add-one-row-to-pandas-dataframe
